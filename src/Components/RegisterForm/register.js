                ...
                <main className="pa4 black-80">
                    <form className="measure">
                        ...
                        <legend className="f2 fw6 ph0 mh0">Register</legend>
                            <div className="mt3">
                                <label className="db fw6 lh-copy f3" for="name">Name</label>
                        ...
                        <div className="lh-copy mt3">
                            <span onClick={() => {props.routeChangeAndFalse('signin')}} className="f4 link dim black db">Back to Sign In</span>
                        </div>
                    </form>
                </main>
            </article>
